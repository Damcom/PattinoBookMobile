...
import com.company.damprovafinal.service.*
...
import com.company.damprovafinal.databinding.ActivityEntitySetListBinding
import com.company.damprovafinal.databinding.ElementEntitySetListBinding
import com.sap.cloud.mobile.foundation.mobileservices.SDKInitializer
import com.sap.cloud.mobile.foundation.usage.UsageService
import com.company.damprovafinal.mdui.books.BooksActivity
...
class EntitySetListActivity : AppCompatActivity() {
    ...
    enum class EntitySetName constructor(val entitySetName: String, val titleId: Int, val iconId: Int) {
        Books("Books", R.string.eset_books,
            BLUE_ANDROID_ICON),
        BooksDetails("BooksDetails", R.string.eset_booksdetails,
            WHITE_ANDROID_ICON)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.setOnItemClickListener listView@{ _, _, position, _ ->
            ...
            val intent: Intent = when (entitySetName) {
                EntitySetName.Books -> Intent(context, BooksActivity::class.java)
                EntitySetName.BooksDetails -> Intent(context, BooksDetailsActivity::class.java)
