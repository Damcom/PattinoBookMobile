package com.company.damprovafinal.service
...
object OfflineWorkerUtil {
    ...
    private const val CONNECTION_ID_ENTITYCONTAINER = "DamOdata"
    ...
    fun initializeOffline(
        ...
        try {
            ...
            offlineODataProvider = OfflineODataProvider(
                ...
                val booksQuery = OfflineODataDefiningQuery("Books", "Books", false)
                addDefiningQuery(booksQuery)
                val booksDetailsQuery = OfflineODataDefiningQuery("BooksDetails", "BooksDetails", false)
                addDefiningQuery(booksDetailsQuery)
